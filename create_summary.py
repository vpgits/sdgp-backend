...
# async def create_summary_json_fireworks(text):
...
#             {"role": "system",
#              "content": """You are to find key points at a user given text.
#                                                               Return only a JSON. The JSON should only have an
#                                                              array with only label called "key_points" Here is the schema.{
...
#   """},
#             {"role": "user",
#              "content": f"{text}. Return only a JSON. I am parsing the output so no greet text"""}
#         ],
#         stream=False,
#         n=1,
#         max_tokens=4096,
